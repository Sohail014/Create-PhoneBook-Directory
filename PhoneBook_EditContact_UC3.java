...
public class PhoneBook_EditContact_UC3 {
    ...
    private void displayContactDetails() {
        ...
        for (int i = 0; i < contactList.size(); i++) {
            ...
            System.out.println(" phone number is :" + con.landLineNumber);
    ...
    private void editContact() {
        ...
        Details contactToBeEdited = contactList.get(0);
        System.out.println(contactList.get(0));

        for (int j = 0; j < contactList.size(); j++) {
            Details conMatch = contactList.get(j);
    ...
    public static void main(String[] args) {
        ...
        PhoneBook_EditContact_UC3 entry3 = new PhoneBook_EditContact_UC3();
